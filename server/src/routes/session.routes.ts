...
router.post('/rdp', sessionRateLimiter, validate(sessionSchema), sessionController.createRdpSession);
...
router.post('/vnc', sessionRateLimiter, validate(sessionSchema), sessionController.createVncSession);
...
router.post('/ssh', sessionRateLimiter, validate(sessionSchema), sessionController.validateSshAccess);
